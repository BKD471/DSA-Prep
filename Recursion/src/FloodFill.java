...
import static helper.CodeHelper.displayArrOfArrHelper;

class Solution16 {
    public static void solve(int[][] image,boolean[][] visited,int row,int col,int color,int m,int n,int keys){
...
public class FloodFill {
    public static void main(String[] args) {
        ...
        int[][] res=Solution16.floodFill(image,1,1,2);
        displayArrOfArrHelper(res);
    }
}
